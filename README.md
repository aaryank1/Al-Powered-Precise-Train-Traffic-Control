...
- Run `streamlit run streamlit_app.py` to open the tick-by-tick network visualizer.
...
- Streamlit network visualization,
- per-train and simulator metrics.

LangGraph tools, editable scenarios, and richer dashboard controls are future
layers on top of this deterministic engine.
...
- future idea: expand the Streamlit dashboard with editable scenarios and more trains.
- train journey duration to be added for each.
